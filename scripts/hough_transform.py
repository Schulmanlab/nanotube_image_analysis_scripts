...
ax[0].set_title('Input majority image')

ax[1].imshow(image_647, cmap=cm.gray)
ax[1].set_title('Input minority image')

ax[2].imshow(fill_tubes, cmap=cm.gray)
ax[2].set_title('Canny edges majority')

ax[3].imshow(fill_tubes_647, cmap=cm.gray)
ax[3].set_title('Canny edges minority')
