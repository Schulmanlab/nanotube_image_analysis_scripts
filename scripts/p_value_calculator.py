...
for i in range (100000):
	...
	if constant_error < bernie_error:
		success += 1

prob = float(success)/100000
print "probability of constant < bernie: ", prob
...
for i in range (100000):
	...
	if constant_error < hill_error:
		success += 1

prob = float(success)/100000
print "probability of constant < hill: ", prob
...
for i in range (100000):
	...
	if bernie_error < hill_error:
		success += 1

prob = float(success)/100000
print "probability of bernie < hill: ", prob
